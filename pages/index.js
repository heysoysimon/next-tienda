 ...
 <div className={style.banner}>
          <div className={style.bannerBackground}>
            <div className={style.bannerInfo}>
              <h2>Todo lo que Deseas Esta  Aqui
              </h2>
              <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas placerat mauris at mauris
               consequat, ut varius sem congue. Nullam blandit quam nec orci maximus.
              </p>
              <Link href='/tienda'>
...
export async function getStaticProps({items}){
   const respuesta = await getLatestItems()
